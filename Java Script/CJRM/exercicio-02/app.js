...
const quantidade = programmingLanguage.length
...
//console.log(harryPotterAuthor.slice(0))
...
const realBestMovie = `${bestMovie.replace('"La la land"', '"Monnligth"' )}`
...
newName = `${nome[0].toLocaleUpperCase()}${nome.slice(1,6)} ${nome[7].toUpperCase()}${nome.slice(8, 12)} `
