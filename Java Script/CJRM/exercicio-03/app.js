...
*/
//brazilianFoods = ['Coxinha', 'null', 'Brigadeiro'] miha resolução!
...
//const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length}, itens: ${brazilianFoods.join(', ')}` MINHA RESOLUÇÃO
